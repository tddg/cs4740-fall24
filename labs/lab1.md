...
parent: Labs
nav_order: 2
due_date: "Wednesday Sep 25, 11:59pm ET"
---
...
[here](https://tddg.github.io/cs4740-fall24/assets/lab_code/lab1.tar). 


Or you can download the tar file from a Linux environment using `wget`:


```sh
% cd $HOME
% wget https://tddg.github.io/cs4740-fall24/assets/lab_code/lab1.tar
% tar -xvf lab1.tar
% ls
src/
```

You should create a parent directory called `cs4740-fall24-labs` from your
working directory, and move the `src` directory into `cs4740-fall24-labs`.

```sh
% mkdir cs4740-fall24-labs
% cp -r src cs4740-fall24-labs/
...
Note that your local tests may show different execution times than
what is shown above. 
...
<tr><td>Part V (Extra credit challenge: ./test-ii.sh)</td><td>(5)</td></tr>
</table></p>
...
(If you worked out Part V's challenges, you should create a tar file that includes five files instead of four as follows:)
...
include the four (or five including `ii.go`) Go source files, and this is
just for the GTAs' record.
